...
class YapController {
    ...
    createOrRevealPanel() {
        ...
        const panel = vscode.window.createWebviewPanel('yapRecorder', 'Yap Recorder', { viewColumn: vscode.ViewColumn.Beside, preserveFocus: true }, { enableScripts: true, retainContextWhenHidden: true });
